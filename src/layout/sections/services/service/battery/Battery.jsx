...
export const Battery = ({more, small}) => {
    const finalyImg = small ? "battery-image battery-small" : "battery-image"

    return (
        <div className="battery">
            <img src={battery} alt="battery charge" className={finalyImg}/>
            <div className="battery-text">
                ...
                {more ?
                    <div>
                        ...
                        <NavLink to={'/battery'}>...more</NavLink>
                    </div> :
                    <p>
                        Introducing our innovative taxi service that goes the extra mile to provide assistance when you
                        find yourself stranded with a dead battery. We understand the frustration and inconvenience of a
